    ...
    try:
        with zmq_socket_ctx(handshake_bind_address, zmq.ROUTER, bind=True) as handshake_socket:
            ...
            wait_for_engine_startup(
                ...
                CoreEngineLaunch(None, coordinator, addresses, None),
            )
    finally:
        omni_master_server.release_route_port_reservations(
            stage_id,
    ...
    try:
        with zmq_socket_ctx(handshake_bind_address, zmq.ROUTER, bind=True) as handshake_socket:
            ...
            wait_for_engine_startup(
                ...
                False,
                None,
                CoreEngineLaunch(None, None, addresses, None),
            )
    finally:
        omni_master_server.release_route_port_reservations(
            stage_id,
    ...
    try:
        with zmq_socket_ctx(handshake_bind_address, zmq.ROUTER, bind=True) as handshake_socket:
            ...
            wait_for_engine_startup(
                ...
                vllm_config.cache_config,
                CoreEngineLaunch(local_engine_manager, coordinator, addresses, None),
            )
    finally:
        omni_master_server.release_route_port_reservations(
            stage_id,
    ...
    *,
    ...
    with zmq_socket_ctx(handshake_address, zmq.ROUTER, bind=True) as handshake_socket:
        ...
        wait_for_engine_startup(
            ...
            False,  # coordinated_dp
            vllm_config.cache_config,
            CoreEngineLaunch(engine_manager, None, addresses, None),
        )
